...
def testAcc():
    ...
    for file_txt in data_txt:
        ...
        for index in range(0, len(frames) - 1):
            ...
            plt.savefig("/home/abaozheng6/View_Synthesis/synsin/demos/dataset_acc_0217/input/{}_{}_test_in.png".format(file_txt, str(int(frame[0]))))
            plt.imshow(pred_imgs[0].squeeze().cpu().permute(1,2,0).numpy() * 0.5 + 0.5)
            plt.savefig("/home/abaozheng6/View_Synthesis/synsin/demos/dataset_acc_0217/pred/{}_{}_test_pred.png".format(file_txt, str(int(frame[0]))))
